...
1. once an pstn or test web app call has been established, run `curl http://localhost:8080/recognize?acstarget=ACSTestAppUser`. and ensure you have prepopulated the pstnNumber variable with the calling number.  
